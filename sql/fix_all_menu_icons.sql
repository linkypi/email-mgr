...
-- 2. 个人邮件子菜单图标设置
-- 2.1 收件箱
UPDATE sys_menu SET icon = 'inbox' WHERE menu_id = 2001;

-- 2.2 发件箱
UPDATE sys_menu SET icon = 's-promotion' WHERE menu_id = 2004;

-- 2.3 星标邮件
UPDATE sys_menu SET icon = 'star-on' WHERE menu_id = 2007;

-- 2.4 已删除
UPDATE sys_menu SET icon = 'delete' WHERE menu_id = 2010;
...
-- 3.4 标签管理
UPDATE sys_menu SET icon = 'collection-tag' WHERE menu_id = 2050;
...
-- 4.2 邮件批量发送
UPDATE sys_menu SET icon = 's-promotion' WHERE menu_id = 2080;
...
-- 5.2 邮件追踪
UPDATE sys_menu SET icon = 'track' WHERE menu_id = 3010;
