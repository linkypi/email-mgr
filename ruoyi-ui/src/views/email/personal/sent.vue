          ...
          >
            ...
            <div class="mail-content">
              ...
              <div class="mail-sender">
                <span class="sender-info">发件人: {{ mail.sender || '我' }}</span>
                <span v-if="mail.isRead === 0" class="mail-unread"></span>
              </div>
              
              <!-- 第三行：收件人信息 -->
              <div class="mail-recipient">
                <span class="recipient-info">收件人: {{ mail.recipient }}</span>
              </div>
            ...
            <div class="mail-time">{{ parseTime(mail.sentTime, '{m}-{d} {h}:{i}') }}</div>
          </div>
        ...
        <div v-if="selectedMail" class="mail-preview-header">
          ...
          <div class="preview-actions-row">
            ...
            <div class="preview-actions">
              ...
              <el-button size="mini" icon="el-icon-star-off" @click="handleToggleStar(selectedMail)">取消星标</el-button>
          ...
          <div class="preview-sender-row">
            ...
            <span class="sender-email">{{ selectedMail.sender || '我' }}</span>
          </div>
          ...
          <div v-if="selectedMail && showCompose" class="compose-form">
            ...
            <div class="compose-header">
              <div class="compose-title">
                ...
                <span class="compose-sender">{{ selectedMail.sender || '我' }}</span>
              </div>
            ...
            <div class="original-email-box">
              ...
              <div class="original-email-content">
                <div class="original-email-info">
                  <div><strong>发件人:</strong> {{ selectedMail.sender || '我' }} &lt;{{ selectedMail.sender || '我' }}&gt;</div>
                  <div><strong>发件时间:</strong> {{ parseTime(selectedMail.sentTime, '{y}年{m}月{d}日 {h}:{i}') }}</div>
                  <div><strong>收件人:</strong> {{ selectedMail.recipient }} &lt;{{ selectedMail.recipient }}&gt;</div>
    ...
    <el-dialog title="邮件筛选" :visible.sync="showFilterDialog" width="500px">
      <el-form :model="filterForm" label-width="80px">
        <el-form-item label="收件人">
          <el-input v-model="filterForm.recipient" placeholder="请输入收件人" />
        </el-form-item>
  ...
  methods: {
    ...
    getUnreadCount() {
      ...
      getSentUnreadCount().then(response => {
        ...
        // 但可以用于其他统计目的
        console.log('发件箱未读数量:', response.data);
      }).catch(() => {
        // 忽略错误，不影响主要功能
      });
    },
    ...
    handleReply() {
      ...
      // 设置回复邮件信息
      this.composeForm.toAddress = this.selectedMail.recipient;
    ...
    async handleSend() {
      ...
      try {
        ...
        if (isReply || isForward) {
          ...
          // 调试信息
          console.log('发送回复/转发邮件:', {
            mode: this.composeMode,
            originalMessageId: this.composeForm.originalMessageId,
