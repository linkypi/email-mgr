  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户角色" prop="roleCode">
        <el-select v-model="queryParams.roleCode" placeholder="请选择用户角色" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户角色" align="center" prop="roleCode" width="120">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="用户角色" prop="roleCode">
              <el-select v-model="form.roleCode" placeholder="请选择用户角色">
                <el-option
                  v-for="role in roleOptions"
                  :key="role.code"
                  :label="role.info"
...
import { getUserRoles } from "@/api/system/userRole";
